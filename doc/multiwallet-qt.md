...
Only requiring some minor changes is mxn.cpp.
...
Changes to mxn.cpp
----------------------
mxn.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
