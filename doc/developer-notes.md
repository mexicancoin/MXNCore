...
MexicanCoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as MexicanCoin Core, where everyone uses
...
pay attention to for reviewers of MexicanCoin Core code.

General MexicanCoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: MexicanCoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
