...
MexicanCoin Core version 0.12.0 is now available from:

  https://mxnpay.io/downloads

Please report bugs using the issue tracker at github:

  https://github.com/mxncoin/mxn/issues
...
backwards-compatible with pre-0.12 versions of MexicanCoin Core or other software:
