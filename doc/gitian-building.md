...
*Setup instructions for a Gitian build of MexicanCoin Core using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the MexicanCoin
...
- [Building MexicanCoin Core](#building-mxn-core)
...
Clone the git repositories for MexicanCoin Core and Gitian.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/mxncoin/mxn
```
...
in the MexicanCoin Core repository under 'Fetch and build inputs' to install sources which require
...
To build MexicanCoin Core (for Linux, OS X and Windows) just follow the steps under 'perform
Gitian builds' in [doc/release-process.md](release-process.md#perform-gitian-builds) in the MexicanCoin Core repository.
...
```bash
    ...
    From https://github.com/mxncoin/mxn
...
[mxn/gitian.sigs](https://github.com/mxncoin/gitian.sigs/) repository, or if that's not possible to create a pull
request.
