 ...
 *
 *   // network
 *   CMexicanCoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
// // root node
class CMexicanCoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CMexicanCoinNetwork(UniValue objIn)
    {
...
// // can be under: MexicanCoinNetwork
// //   -- signature requirements : Key1(User)
// class CMexicanCoinNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == MexicanCoinNetwork);
//     // }
