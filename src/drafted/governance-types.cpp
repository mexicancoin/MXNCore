...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "MexicanCoinNetwork") type = MexicanCoinNetwork;
    if(strType == "MexicanCoinNetworkVariable") type = MexicanCoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == MexicanCoinNetwork) s = "MexicanCoinNetwork";
    if(type == MexicanCoinNetworkVariable) s = "MexicanCoinNetworkVariable";
