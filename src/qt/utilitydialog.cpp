    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("MexicanCoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About MexicanCoin Core"));
...
All the MexicanCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 MUE, 0.1 MUE, 1 MUE and 10 MUE -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
                          tr("MexicanCoin Core is shutting down...") + "<br /><br />" +
