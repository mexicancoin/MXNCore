    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("MexicanCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MexicanCoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About MexicanCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about MexicanCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MexicanCoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MexicanCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MexicanCoin addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the MexicanCoin Core help message to get a list with possible MexicanCoin Core command-line options"));
...
void BitcoinGUI::createToolBars()
{
    if(walletFrame)
    {
        ...
        toolbar->addAction(mxnbankAction);
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("MexicanCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MexicanCoin network", "", count));
}
...
{
    QString strTitle = tr("MexicanCoin Core"); // default title
    ...
    // Append title to "MexicanCoin Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
