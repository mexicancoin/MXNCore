...
bool LogAcceptCategory(const char* category)
{
    if (category != NULL)
    {
        ...
        if (ptrCategory.get() == NULL)
        {
            ...
            // "mxn" is a composite category enabling all MexicanCoin-related debug output
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\MexicanCoinCore
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\MexicanCoinCore
    // Mac: ~/Library/Application Support/MexicanCoinCore
    // Unix: ~/.mxncore
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "MexicanCoinCore";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/MexicanCoinCore";
#else
    // Unix
