/* src/config/mxn-config.h.  Generated from mxn-config.h.in by configure.  */
/* src/config/mxn-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://github.com/mxncoin/mxn/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "MexicanCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "MexicanCoin Core 1.0.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "mxncore"
